    ...
    <body>
        ...
        <div class="container">
            ...
            <form:form id="form1" class="form-horizontal" enctype="multipart/form-data"
                       method="post" action="save_clear?${_csrf.parameterName}=${_csrf.token}" >
                <fieldset>
                                ...
                                <div class="col-md-3">
                                    <mark>
                                        <a href="<c:url value='/download?id=${ticketHeader.ticketNo}' />" target="_blank">
                                            <img border="0" alt="${ticketHeader.ticketNo}" src="<c:url value='/resources/img/pdf.png' />" width="25" height="25">

                                ...
                                <div class="btn-group pull-right">
                                    ...
                                    <c:if test="${(fn:contains(ticketHeader.ticketNo, '-C'))}"> 
                                        ...
                                        <c:if test="${principal.username eq ticketHeader.applicationName and ticketHeader.approvedStatus1 eq false or ticketHeader.ticketFinished eq 'R'}"> 
                                            ...
                                            <a href="<c:url value='/advance/edit_clear?id=${ticketHeader.ticketNo}'/>" class="btn btn-primary btn-lg"><i class="fa fa-pencil-square-o"></i> Edit </a>
                                    ...
                                    <c:if test="${(!fn:contains(ticketHeader.ticketNo, '-C'))}"> 
                                        <c:if test="${principal.username eq ticketHeader.applicationName and ticketHeader.approvedStatus1 eq false or ticketHeader.ticketFinished eq 'R'}"> 
                                            ...
                                            <a href="<c:url value='/advance/edit?id=${ticketHeader.ticketNo}'/>" class="btn btn-primary btn-lg"><i class="fa fa-pencil-square-o"></i> Edit </a>

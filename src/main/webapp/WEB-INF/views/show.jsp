                            ...
                            <div class="panel-heading clearfix">
                                ...
                                <div class="btn-group pull-right">
                                    ...
                                    <c:if test="${(fn:contains(ticketHeader.ticketNo, '-C'))}"> 
                                        <a href="<c:url value='show?id=${ticketHeader.refTicketNo}'/>" class="btn btn-default btn-sm" target="_blank">## ${ticketHeader.refTicketNo}</a> 
                                        ...
                                        <c:if test="${principal.username eq ticketHeader.applicationName and ticketHeader.approvedStatus1 eq false or ticketHeader.ticketFinished eq 'R'}"> 
                                            ...
                                            <a href="<c:url value='/entertain/edit_clear?id=${ticketHeader.ticketNo}'/>" class="btn btn-primary btn-lg"><i class="fa fa-pencil-square-o"></i> Edit </a>
                                    ...
                                    <c:if test="${(!fn:contains(ticketHeader.ticketNo, '-C'))}"> 
                                        <c:if test="${principal.username eq ticketHeader.applicationName and ticketHeader.approvedStatus1 eq false or ticketHeader.ticketFinished eq 'R'}"> 
                                            ...
                                            <a href="<c:url value='/entertain/edit?id=${ticketHeader.ticketNo}'/>" class="btn btn-primary btn-lg"><i class="fa fa-pencil-square-o"></i> Edit </a>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="panel panel-success">
                                            ...
                                            <div class="panel-body">
                                                <table id="jack" class="table table-striped">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <c:forEach var="ticketdetail" items="${ticketDetail}">
                                                            <tr>
                                                                ...
                                                                <td style="width:400px; word-wrap: break-word; display:block;">
                                                                    ${ticketdetail.detail}
                                                                </td>
                                                                <td>
                                                                    ${ticketdetail.amount}

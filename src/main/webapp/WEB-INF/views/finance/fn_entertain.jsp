...
<html>
    ...
    <body>
        ...
        <div class="container">
            <fieldset>
                <legend><i class="fa fa-btc"></i> Finance (Entertain)</legend>
            </fieldset>
            ${search}
                            ...
                            <div class="panel panel-success">
                                <table class="table table-striped" id="example">
                                    ...
                                    <c:forEach var="ticketHeader" items="${ticketHeaderListFinance}">
                                        ...
                                        <tr>
                                            <td> <a href="<c:url value='show?id=${ticketHeader.ticketNo}&areaTab=all'/>" class="btn btn-danger">show</a></td>
                            ...
                            <div class="panel panel-success">
                                <table class="table table-striped" id="thaniya">
                                    ...
                                    <c:forEach var="ticketHeader" items="${THANIYA}">
                                        ...
                                        <tr>
                                            <td> <a href="<c:url value='show?id=${ticketHeader.ticketNo}&areaTab=thaniya'/>" class="btn btn-danger">show</a></td>
                                            <td><c:if test="${empty ticketHeader.showTicket}">
                                                    ${ticketHeader.ticketNo}
                                                </c:if>
                                                <c:if test="${not empty ticketHeader.showTicket}">
                            ...
                            <div class="panel panel-success">
                                <table class="table table-striped" id="blc">
                                    ...
                                    <c:forEach var="ticketHeader" items="${BLC}">
                                        ...
                                        <tr>
                                            <td> <a href="<c:url value='show?id=${ticketHeader.ticketNo}&areaTab=blc'/>" class="btn btn-danger">show</a></td>
                                            <td><c:if test="${empty ticketHeader.showTicket}">
                                                    ${ticketHeader.ticketNo}
                                                </c:if>
                                                <c:if test="${not empty ticketHeader.showTicket}">
                            ...
                            <div class="panel panel-success">
                                <table class="table table-striped" id="nlc">
                                    ...
                                    <c:forEach var="ticketHeader" items="${NLC}">
                                        <tr>
                                            <td> <a href="<c:url value='show?id=${ticketHeader.ticketNo}&areaTab=nlc'/>" class="btn btn-danger">show</a></td>
                                            <td><c:if test="${empty ticketHeader.showTicket}">
                                                    ${ticketHeader.ticketNo}
                                                </c:if>
                                                <c:if test="${not empty ticketHeader.showTicket}">
                            ...
                            <div class="panel panel-success">
                                <table class="table table-striped" id="airport">
                                    ...
                                    <c:forEach var="ticketHeader" items="${AIRPORT}">
                                        ...
                                        <tr>
                                            <td> <a href="<c:url value='show?id=${ticketHeader.ticketNo}&areaTab=airport'/>" class="btn btn-danger">show</a></td>
                                            <td><c:if test="${empty ticketHeader.showTicket}">
                                                    ${ticketHeader.ticketNo}
                                                </c:if>
                                                <c:if test="${not empty ticketHeader.showTicket}">
                            ...
                            <div class="panel panel-success">
                                <table class="table table-striped" id="ncc">
                                    ...
                                    <c:forEach var="ticketHeader" items="${NCC}">
                                        ...
                                        <tr>
                                            <td> <a href="<c:url value='show?id=${ticketHeader.ticketNo}&areaTab=ncc'/>" class="btn btn-danger">show</a></td>
                                            <td><c:if test="${empty ticketHeader.showTicket}">
                                                    ${ticketHeader.ticketNo}
                                                </c:if>
                                                <c:if test="${not empty ticketHeader.showTicket}">
                            ...
                            <div class="panel panel-success">
                                <table class="table table-striped" id="laemchabang">
                                    ...
                                    <c:forEach var="ticketHeader" items="${LAEMCHABANG}">
                                        ...
                                        <tr>
                                            <td> <a href="<c:url value='show?id=${ticketHeader.ticketNo}&areaTab=laemchabang'/>" class="btn btn-danger">show</a></td>
                                            <td><c:if test="${empty ticketHeader.showTicket}">
                                                    ${ticketHeader.ticketNo}
                                                </c:if>
                                                <c:if test="${not empty ticketHeader.showTicket}">
                            ...
                            <div class="panel panel-success">
                                <table class="table table-striped" id="korat">
                                    ...
                                    <c:forEach var="ticketHeader" items="${KORAT}">
                                        ...
                                        <tr>
                                            <td> <a href="<c:url value='show?id=${ticketHeader.ticketNo}&areaTab=korat'/>" class="btn btn-danger">show</a></td>
                                            <td><c:if test="${empty ticketHeader.showTicket}">
                                                    ${ticketHeader.ticketNo}
                                                </c:if>
                                                <c:if test="${not empty ticketHeader.showTicket}">
